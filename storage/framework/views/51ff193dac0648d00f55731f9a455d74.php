  ...
  <body>
    ...
    <script>
      window.ui = SwaggerUIBundle({
        url: '<?php echo e($url ?? route("l5-swagger.default.docs", "api-docs.json", true)); ?>',
        dom_id: '#swagger-ui',
        deepLinking: true,
        presets: [
...
<?php /**PATH C:\ProjetosEstudos\urna-simulado-back\resources\views\vendor\l5-swagger\index.blade.php ENDPATH**/ ?>