...
class CandidateTypeRepository extends BaseRepository
{
    public function __construct(private CandidateType $entity)
    {
    ...
    {
        return $this->entity->withTrashed()->with('candidates')->get();
    }
    ...
    {
        return $this->entity->orderBy('description')->withTrashed()->with('candidates')->paginate($totalPage);
    }

    public function applyFilter(array $items)
	{
		$query = $this->entity::query()->with('candidates');
